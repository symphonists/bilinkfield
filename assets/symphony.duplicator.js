...
-----------------------------------------------------------------------------*/
	...
	jQuery.fn.duplicator = function(custom_settings, custom_strings) {
	/*-------------------------------------------------------------------------
		Initialise
	-------------------------------------------------------------------------*/
		...
		objects = objects.map(function() {
			...
			var methods = {
				...
				prepare:		function(source) {
					var instance = jQuery(source).addClass('instance').addClass('expanded');
					var header = instance.find(settings.headers).addClass('header');
